...
p.hasPathSum = function(targetSum, currentSum) {
  if (currentSum === undefined)
    currentSum = 0;

  currentSum += this.data;

  if (this.isLeaf())
    return targetSum === currentSum;

  if (this.left !== null && this.left.hasPathSum(targetSum, currentSum))
      return true;

  if (this.right !== null && this.right.hasPathSum(targetSum, currentSum))
      return true;
